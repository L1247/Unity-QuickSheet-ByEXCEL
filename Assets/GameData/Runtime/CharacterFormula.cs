...
/// 
[System.Serializable]
public class CharacterFormula : ScriptableObject 
{	
    ...
    public CharacterFormulaData[] dataArray;
    public List<CharacterFormulaData> dataList;
...
//#endif
        ...
        // 		
        if (dataArray == null)
            dataArray = new CharacterFormulaData[0];
